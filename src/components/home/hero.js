             ...
             <div className="col-12 col-md-6">
                 <div className="hero__section d-flex flex-column upercase justify-content-center h-100 align-content-start">
                    ...
                    <div className="hero__buttons d-flex mt-5">
                        <Link to="/blog" className="neu-btn">Blog</Link>
                        <Link to="/projects" className="neu-btn">Projects</Link>
                 </div>
                 </div>
            </div>
            <div className="col-12 col-md-6">
                <div className="hero__svg">
                <img className="laptop img-fluid" src={laptops} alt="laptop"></img>
                <Grid/>
                <svg className="hero__svg--blob" xmlns="http://www.w3.org/2000/svg" width="150%" height="800" viewBox="0 0 1397 1330" >
